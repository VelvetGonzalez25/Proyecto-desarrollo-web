...
@section('content')
  <div class="container">
    <h1 class="text-center">Contactos compartidos conmigo</h1>
    @forelse ($contactsSharedWithUser as $contact)
      <div class="d-flex justify-content-between bg-dark mb-3 rounded px-4 py-2">
        ...
        <div class="d-flex align-items-center">
          ...
          <p class="me-2 mb-0">Compartido por
    ...
    @empty
      <div class="col-md-4 mx-auto">
        <div class="card card-body text-center">
          <p>Aún no se han compartido contactos contigo</p>
        </div>
      </div>
    @endforelse

    <h1 class="text-center">Contactos compartidos por mi</h1>
    ...
    @empty
      <div class="col-md-4 mx-auto">
        <div class="card card-body text-center">
          <p>Aún no has compartido ningún contacto</p>
          <p>Compartir contactos <a
              href="{{ route('contact-shares.create') }}">aquí</a>.</p>
        </div>
      </div>
    @endforelse
  </div>
